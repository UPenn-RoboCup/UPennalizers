...
const char luaInitFilename[] = 
"/home/nao/RoboCup/Lib/Platform/NaoV4/NaoQi/nao_init.lua";
...
int create(boost::shared_ptr<ALBroker> pBroker) {
...
public:
  DcmProcess(boost::shared_ptr<ALBroker> pBroker, const std::string& pName): ALModule(pBroker, pName) {
...
extern "C" int _createModule( boost::shared_ptr<ALBroker> pBroker ) {      
