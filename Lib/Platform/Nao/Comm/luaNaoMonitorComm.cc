...
static int lua_naocomm_send_yuyv(lua_State *L) {
  int updateRet = lua_naocomm_update(L);
...
static int lua_naocomm_send_label(lua_State *L) {
  int updateRet = lua_naocomm_update(L);
...
static int lua_naocomm_send_yuyv2(lua_State *L) {
  int updateRet = lua_naocomm_update(L);
...
static int lua_naocomm_send_particle(lua_State *L) {
  int updateRet = lua_naocomm_update(L);
  std::string dataStr;
...
static const struct luaL_reg NaoMonitorComm_lib [] = {
  ...
  {"send_label", lua_naocomm_send_label},
  {"send_yuyv", lua_naocomm_send_yuyv},
  {"send_yuyv2", lua_naocomm_send_yuyv2},
  {"send_particle", lua_naocomm_send_particle},
  {NULL, NULL}
};
