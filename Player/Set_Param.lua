...
function Set_Brightness()
  print ('Current brightness is: '..camera[camera_idx]:get_param('Brightness')..' type in a integer which is multiple of 4 between 0 and 255');
...
function Set_Contrast()
  print ('Current contrast is: '..camera[camera_idx]:get_param('Contrast')..' type in a integer between 16 and 64');
  local param = Read_Num();
...
function Set_White_Balance()
  print ('Current white balance is: '..camera[camera_idx]:get_param('Do White Balance')..' type in a integer between 2700 and 6500');
  local param = Read_Num();
...
function Set_Saturation()
  print ('Current saturation is: '..camera[camera_idx]:get_param('Saturation')..' type in a integer between 0 and 255');
  local param = Read_Num();
...
function Set_Exposure()
  print ('Current exposure is: '..camera[camera_idx]:get_param('Exposure')..' type in a integer between 0 and 255');
  local param = Read_Num();
  while (param < 0 or param > 255) do
    unix.usleep (10000);
    print ('Type in a integer between 0 and 255');
...
function Set_Gain()
  print ('Current gain is: '..camera[camera_idx]:get_param('Gain')..' type in a integer between 0 and 255');
  local param = Read_Num();
  while (param < 0 or param > 255) do
    unix.usleep (10000);
    print ('Type in a integer between 0 and 255');
...
function Set_Sharpness()
  print ('Current sharpness is: '..camera[camera_idx]:get_param('Sharpness')..' type in a integer between 0 and 5');
  local param = Read_Num();
...
utilCommands =  {'i','+','-','b','c','s','e','g','a','p','h','w','f'}
