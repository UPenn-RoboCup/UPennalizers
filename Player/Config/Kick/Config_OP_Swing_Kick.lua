...
-- {2, duration, torsoTarget, relFootXYA, footHeight, footPitch, bodyPitch} - LF move
-- {3, duration, torsoTarget, relFootXYA, footHeight, footPitch} - RF move
-- {4, duration, torsoTarget, relFootXYA, footHeight, footPitch, bodyPitch} - LF kick
-- {5, duration, torsoTarget, relFootXYA, footHeight, footPitch} - RF kick
-- {6, duration, torsoTarget} -- Return to walk stance
-- {7, duration, torsoTarget, LArmTarget,RArmTarget, bodyHeightTarget, bodyRollTarget, bodyTiltTarget} -- General motion
-----------------------------------------------------------------------------
...
kick.def["kickSideLeft"]={
  supportLeg = 1,
  def = {
    {1, 0.6, {-0.01,-0.05,0} , 0.295          }, --COM slide
    {2, 0.4, {-0.01,-0.055,0} , { 0,      0.04,  0.6}, 0.03 ,0*math.pi/180}, --Lifting
    {4, 0.2, {-0.01,-0.055,0} , { 0.06,  -0.16,  -0.9},  0.03 , 0*math.pi/180}, --Kicking
    {2, 0.4, {-0.01,-0.055,0} , {-0.15,  0.017,  0.3}, 0, 0 }, --Landing
...
kick.def["kickSideRight"]={
  ...
  def = {
    {1, 0.6, {-0.01,0.05,0}   ,0.295       }, --COM slide
    {3, 0.4, {-0.01,0.055,0} ,  {0, -0.04, -0.6}, 0.03 ,0*math.pi/180 }, --Lifting
    {5, 0.2, {-0.01,0.055,0} , {0.06,  0.16, 0.9},  0.03 , 0*math.pi/180}, --Kicking
    {3, 0.4, {-0.01,0.055,0} , {-0.15, -0.017,-0.3}, 0, 0 }, --Landing
    {6, 0.6, {0.00, 0.00, 0}},--Stabilize
 },
}
...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {2, 0.3, {0.01,-0.055,0} , {-0.06,-0.02,0}, 0.05 , 0, 0.2}, --Lifting
     {2, 0.3, {0.00, -0.055,0} , {-0.08,0,0}, 0.13 , 40*math.pi/180 , 0.45},--Lifting
     {4, 0.5, {-0.03,-0.055,0} , {0.30,0,0},  0.07 , -5*math.pi/180, -0.2}, --Kicking
     {2, 0.4, {-0.03,-0.055,0} , {0,0,0},  0.07 , -5*math.pi/180, 0.2}, 
     {2, 0.4, {-0.01,-0.055,0} , {-0.16,0.010,0}, 0, 0, 0.4}, --Landing
     {1, 0.6, {-0.01,-0.02, 0}},--COM slide
...
kick.def["kickForwardRight"]={
  ...
  def = {
    ...
    {3, 0.1, {0.00 ,0.055,0} , {-0.08, 0.0, 0}, 0.13 , 40*math.pi/180}, 
    {5, 0.2, {-0.03 ,0.055,0} , {0.30, 0, 0},  0.07 
,-5*math.pi/180},--Kicking
    {3, 0.2, {-0.03 ,0.055,0} , {0, 0, 0},  0.07 , -5*math.pi/180},--Kicking
    {3, 0.4, {-0.01 ,0.055,0} , {-0.16,-0.010,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.01, 0.02, 0}},--COM slide
    {6, 0.6, {0.000, 0.01, 0}},--Stabilize
  },
}
