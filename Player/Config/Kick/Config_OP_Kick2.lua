...
--Bit more powerful kick

kick.def["kickForwardLeft"]={
   supportLeg = 1, --Right support
   def = {
     {1, 0.6, {-0.01,-0.050,0} , 0.303          }, --COM slide
     {2, 0.2, {-0.01,-0.055,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
--     {2, 0.2, {-0.01, -0.055,0} , {-0.08,0,0}, 0.13 , 40*math.pi/180},
--     {4, 0.2, {-0.03,-0.055,0} , {0.30,0,0},  0.07 , -5*math.pi/180}, 


     {2, 0.2, {-0.01, -0.055,0} , {-0.08,0,0}, 0.13 , 30*math.pi/180},--Lifting
     {4, 0.2, {-0.03,-0.055,0} , {0.30,0,0},  0.07 , -5*math.pi/180}, --Kicking

     {2, 0.2, {-0.03,-0.055,0} , {0,0,0},  0.07 , -5*math.pi/180}, 
...
kick.def["kickForwardRight"]={
  ...
  def = {
    {1, 0.6, {-0.01 ,0.05,0},0.303}, --COM slide
    {3, 0.2, {-0.01 ,0.055,0} , {-0.06, 0.02, 0}, 0.05 , 0},
    {3, 0.2, {-0.01 ,0.055,0} , {-0.08, 0.0, 0}, 0.13 , 40*math.pi/180}, 
    {5, 0.2, {-0.03 ,0.055,0} , {0.30, 0, 0},  0.07 ,-5*math.pi/180},
    {3, 0.2, {-0.03 ,0.055,0} , {0, 0, 0},  0.07 , -5*math.pi/180},
