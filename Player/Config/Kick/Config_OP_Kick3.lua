...
--New kick with zero bodyTilt


bodyPitchTarget =0;
bodyHeightTarget = 0.31;
...
kick.def["kickForwardRight"]={
  supportLeg = 0,
  def = {
    {1, 0.6, {0.0 ,0.050,0},bodyHeightTarget,0,bodyPitchTarget}, 
    {3, 0.3, {0.0 ,0.055,0} , {-0.06, 0.02, 0}, 0.05 , 10*math.pi/180},
    {3, 0.1, {0.0 ,0.055,0} , {-0.04, 0.0, 0}, 0.12 , 30*math.pi/180}, 
    {5, 0.2, {-0.03 ,0.055,0} , {0.26, 0, 0},  
0.09,-5*math.pi/180},--Kicking
    {5, 0.2, {-0.03 ,0.055,0} , {-0.13, -0.010, 0},0.02,0},--Kicking
    {3, 0.6, {-0.01 ,0.055,0} , {-0.03,0,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.01, 0.02, 0},bodyHeightTarget,0,20*math.pi/180},--COM slide
    {6, 0.6, {0.000, 0.01, 0}},--Stabilize
  },
}
