...
--SJ: for generic minihubo model

kick.kickLeft={
        {1, .6, {0,0,0}          }, --Stabilize
        {1, 0.6, {0,-0.05,0}          }, --COM slide
	{2, 0.3, {0,-0.05,0} , {-0.07,-0.03,0}, 0.07 , 20*math.pi/180},--Lifting
        {4, 0.3, {0,-0.05,0} , {0.20,0,0},  0.04 , -10*math.pi/180},--Kicking
	{2, 0.6, {0,-0.05,0} , {-0.13,0.03,0}, 0, 0 }, --Landing
	{1, 0.6, {0.00,-0.0, 0}},--COM slide
	{1, 0.6, {0.00,-0.0, 0}},--Stabilize
	}
...
kick.kickRight={
        {1, .6, {0,0,0}          }, --Stabilize
        {1, 0.6, {0,0.05,0}          }, --COM slide
	{3, 0.3, {0,0.05,0} , {-0.07,0.03,0}, 0.07 , 20*math.pi/180}, --Lifting
        {5, 0.3, {0,0.05,0} , {0.20,0,0},  0.04 , -10*math.pi/180}, --Kicking
	{3, 0.6, {0,0.05,0} , {-0.13,-0.03,0}, 0, 0 }, --Landing
	{1, 0.6, {0.00, 0.0, 0}},--COM slide
	{1, 0.6, {0.00, 0.0, 0}},--Stabilize
	}
