...
team.turnSpeed = 0.8 --2.0; --Average turning time for 360 deg
...
--------------------------------------------------
fsm.bodyReady={};
fsm.bodyReady.maxStep = 0.04; --0.06
...
fsm.bodyGoaliePosition.thClose = {.3, .1, 10*math.pi/180}
...
fsm.bodyApproach.xTarget21={0.1, 0.18,0.20}; --min, target, max 
...
--------------------------------------------------
fsm.headTrack = {};
fsm.headTrack.timeout = 10.0 * speedFactor;
