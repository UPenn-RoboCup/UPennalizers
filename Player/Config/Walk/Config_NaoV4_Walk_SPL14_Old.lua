...
walk.velLimitX={-.04,.04}; --from -0.04, 0.08
...
walk.odomScale = {1.4, 0.97567, 0.80}; --Old X: 0.782
...
-- Gait parameters
---------------------------------------------
walk.tStep = 0.3; --from 0.245
walk.tZmp = 0.17;
walk.supportY = 0.002;
--walk.stepHeight = 0.020;
walk.stepHeight=0.024; --from 0.022
...
if robotName=="tink" then
 ...
 walk.hardnessSupport=0.9;
end


if robotName=="ruffio" then
  walk.odomScale={1.3,0.95,0.55};
end
--[[
