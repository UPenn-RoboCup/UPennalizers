...
--------------------------------------------
walk.compensationEnable = 0;
walk.hipRollCompensation = 1.5*math.pi/180*walk.compensationEnable;
walk.ankleMod = vector.new({-1,0})/0.12 * 10*math.pi/180*walk.compensationEnable;

--------------------------------------------------------------
--Imu feedback parameters, alpha / gain / deadband / max
--------------------------------------------------------------
--Disable imu feedback for webots
walk.gyroFactor = 0.000;
