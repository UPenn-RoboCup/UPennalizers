...
camera.param[1] = {key='Contrast'       , val={50 , 40}};
...
camera.param[4] = {key='Exposure'       , val={50 , 83}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={32 , 60}};
...
camera.lut_file = {'lutTopAustin.raw','lutBottomAustin.raw'};
