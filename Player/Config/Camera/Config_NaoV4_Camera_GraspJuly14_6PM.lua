...
camera.param[1] = {key='Contrast'       , val={40 , 30}};

camera.param[2] = {key='Saturation'       , val={160 , 220}};
...
camera.param[5] = {key='Gain'       , val={70 , 70}};
...
camera.lut_file = {'lut_GraspJuly14_6PMTop.raw','lut_GraspJuly14_6PMBot.raw'};
