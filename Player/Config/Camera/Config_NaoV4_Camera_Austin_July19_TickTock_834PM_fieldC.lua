...
camera.param[1] = {key='Contrast'       , val = {30, 40}}; -- Old Values val={50 , 40}};

camera.param[2] = {key='Saturation'       , val={255 , 200}};
...
camera.param[5] = {key='Gain'       , val={45 , 35}};
...
camera.param[12] = {key='White Balance Temperature'       , val={3400 , 3400}}
...
camera.lut_file = {'lutEmmettTanmayTOP.raw','lutEmmettTanmayBOTTOM.raw'};
