...
camera.param[2] = {key='Saturation'       , val={160 , 200}};
...
camera.param[4] = {key='Exposure'       , val={35 , 35}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={65 , 75}};
...
camera.param[10]  = {key='Do White Balance'       , val={2800 , 2700}}
...
camera.lut_file = {'lut_testcolor.raw','lut_testcolor.raw'};
