...
camera.param[1] = {key='Contrast'       , val={35 , 30}};

camera.param[2] = {key='Saturation'       , val={185 , 160}};
...
camera.param[5] = {key='Gain'       , val={45 , 65}};
...
camera.param[10]  = {key='Do White Balance'       , val={2800 , 3000}}

-- brightness has to be set seperately from other parameters, and it can only be set to multiple of 4
camera.brightness = 200;

camera.lut_file = {'lut_GraspJuly14_6PMTop.raw','lut_GraspJuly14_6PMTop.raw'};
