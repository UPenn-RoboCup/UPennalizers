...
camera.param[1] = {key='Contrast'       , val={35 , 20}};

camera.param[2] = {key='Saturation'       , val={185 , 200}};
...
camera.param[4] = {key='Exposure'       , val={40 , 40}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={45 , 40}};
...
camera.lut_file = {'lut_GraspJuly14_6PMTop.raw','lut_grasp119btm.raw'};
