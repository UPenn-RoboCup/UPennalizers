...
camera.param[1] = {key='Contrast'       , val={45 , 30}};

camera.param[2] = {key='Saturation'       , val={180 , 185}};
...
camera.param[4] = {key='Exposure'       , val={45 , 25}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={50 , 65}};
...
camera.lut_file = {'lut_grasp118top.raw','lut_grasp118btm.raw'};
