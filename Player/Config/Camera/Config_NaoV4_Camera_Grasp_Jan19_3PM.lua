...
camera.param[1] = {key='Contrast'       , val={50 , 30}};

camera.param[2] = {key='Saturation'       , val={115 , 160}};
...
camera.param[4] = {key='Exposure'       , val={40 , 15}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={32 , 65}};
...
camera.param[10]  = {key='Do White Balance'       , val={3000 , 3000}}

-- brightness has to be set seperately from other parameters, and it can only be set to multiple of 4
camera.brightness = 200;

camera.lut_file = {'lut_Grasp_Jan20_3PM_top.raw','lut_Grasp_Jan19_3PM_bot.raw'};
