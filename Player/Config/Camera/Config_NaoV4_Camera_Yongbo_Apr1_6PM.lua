...
camera.param[1] = {key='Contrast'       , val={32 , 32}};

camera.param[2] = {key='Saturation'       , val={170 , 170}};
...
camera.param[4] = {key='Exposure'       , val={140 , 140}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={60 , 60}};
...
camera.lut_file = {'Yongbo_newball1_top.raw','Yongbo_newball1_btm.raw'};
