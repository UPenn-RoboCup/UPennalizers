...
camera.param[1] = {key='Contrast'       , val = {55, 40}}; -- Old Values val={50 , 40}};

camera.param[2] = {key='Saturation'       , val={210 , 200}};
...
camera.param[4] = {key='Exposure'       , val={125 , 110}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={50 , 35}};
...
camera.param[11] = {key='Gamma'       , val={220 , 170}}

camera.param[12] = {key='White Balance Temperature'       , val={4000 , 4075}}
...
camera.lut_file = {'Austin_Ruffio_top_July19_320PM.raw','Austin_Ruffio_bot_July19_320PM.raw'};
