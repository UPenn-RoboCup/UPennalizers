...
camera.param[12] = {key='White Balance Temperature'       , val={6000 , 6500}}
...
camera.lut_file = {'Germany2016_10am_Top_shadowadjusted.raw','Germany2016_10am_Bottom_shadowadjusted2.raw'};
