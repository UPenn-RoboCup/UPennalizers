...
camera.param[1] = {key='Contrast'       , val={34 , 40}};
...
camera.param[4] = {key='Exposure'       , val={140 , 170}};
-- Gain should be set between 32 and 255
camera.param[5] = {key='Gain'       , val={40 , 35}};
...
camera.lut_file = {'lutEmmettAlexNov22TOP.raw','lutEmmettAlexBOTTOM.raw'};
