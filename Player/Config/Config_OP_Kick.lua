...
kick.def["kickForwardLeft"]={
   ...
   def = {
     ...
     {6, 0.6, {0.000, -0.01, 0},kick.bodyHeight},--Stabilize
   },
};
...
kick.def["kickFrontLeft"]={
  supportLeg = 1,
  def = {
    {1, 0.6, {-0.01 ,-0.05,0} , 0.303          }, --COM slide
    {2, 0.3, {-0.01 ,-0.05,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
    {2, 0.1, {-0.01, -0.05,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180}, --Lifting
    {2, 0.1, {-0.01 ,-0.05,0} , {0.25,0,0},  0.18 , -70*math.pi/180}, --Kicking
    {4, 0.3, {-0.01 ,-0.05,0} , {0.10,0,0},  0.20 , -70*math.pi/180}, --Kicking
    {2, 0.6, {-0.01 ,-0.05,0} , {-0.20,0.010,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.00 ,-0.02, 0}},--COM slide
    {6, 0.6, {0.000, -0.010, 0}},--Stabilize
  },
}
...
kick.def["kickFrontLeft"]={
  ...
  def = {
    ...
    {2, 0.3, {-0.01 ,-0.05,0} , {-0.06,-0.02,0}, 0.05 , 0}, --Lifting
    {2, 0.1, {-0.01, -0.05,0} , {-0.06,0,0}, 0.10 , 40*math.pi/180}, --Lifting
    {2, 0.3, {-0.01 ,-0.05,0} , {0.20,0,0},  0.12 , -40*math.pi/180}, --Kicking
--    {2, 0.3, {-0.01 ,-0.05,0} , {0.05,0,0},  0.40 , -70*math.pi/180}, --Kicking
    {4, 0.3, {-0.01 ,-0.05,0} , {0.05,0,0},  0.40 , -70*math.pi/180}, --Kicking
    {2, 0.3, {-0.01 ,-0.05,0} , {0.0,0,0},  0.12 , -40*math.pi/180}, --Kicking
    {2, 0.6, {-0.01 ,-0.05,0} , {-0.13,0.010,0}, 0, 0 }, --Landing
    {1, 0.6, {-0.00 ,-0.02, 0}},--COM slide
    {6, 0.6, {0.000, -0.010, 0}},--Stabilize
  },
}

--new arm pose for webots
kick.qLArm=math.pi/180*vector.new({135,22,-65});
kick.qRArm=math.pi/180*vector.new({135,-22,-65});
...
kick.kickRight={
  ...
  {3, 0.2, {-0.030 ,0.055,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180, -40*math.pi/180}, --Kicking

  {3, 0.3, {-0.030 ,0.055,0} , {-0.30, 0.0, 0}, 0.10 , 40*math.pi/180 , 40*math.pi/180}, 
  {3, 0.3, {-0.030 ,0.055,0} , {0.30, 0, 0},  0.07 , 0*math.pi/180, -40*math.pi/180}, --Kicking
